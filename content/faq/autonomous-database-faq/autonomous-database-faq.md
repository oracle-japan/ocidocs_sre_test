...
description: "Autonomous Database に関して、利用時のよくある質問に対する回答や、ノウハウ/Tipsについて記載しています。"
layout: faq
categories:
  - FAQ
  - services
...
aliases: "/faq/services/autonomous/autonomous-database-faq/"
---
...
パッチはOracle側であらかじめリスクがないかテスト・評価されたうえで適用されます。また、強化されたSQL実行計画管理機能（SPM）により実行計画の変化に伴う性能影響が出ないよう自動管理されております。
